      ...
      <aside className="sticky top-0 hidden h-screen w-56 shrink-0 flex-col border-r border-line bg-card md:flex">
        ...
        <div className="border-t border-line p-3">
          <div className="border border-line bg-paper p-3.5">
            ...
            <button className="mt-3 w-full bg-ink py-2 text-xs font-medium text-paper transition hover:opacity-85">
              Otwórz czat
            </button>
          </div>
      ...
      <div className="min-w-0 flex-1">
        <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-line bg-paper/85 px-4 backdrop-blur-md sm:px-8">
          ...
          <div className="flex items-center gap-2.5">
            <button
              className="relative flex h-8 w-8 items-center justify-center border border-line text-ink-soft transition hover:border-ink hover:text-ink"
            ...
            >
              ...
              <span className="absolute -right-1 -top-1 flex h-3.5 w-3.5 items-center justify-center bg-accent font-mono text-[8px] font-bold text-white">3</span>
            </button>
            <ThemeToggle />
            <div className="flex h-8 w-8 items-center justify-center bg-accent-soft font-mono text-[11px] font-semibold text-accent">TT</div>
          </div>
        </header>
